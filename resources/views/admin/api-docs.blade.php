...
<div class="mb-8 bg-slate-900 border border-slate-800 rounded-2xl p-6">
    ...
    <pre class="bg-slate-950 border border-slate-800 rounded-xl p-4 font-mono text-xs text-slate-300 overflow-x-auto leading-relaxed"><span class="text-emerald-400">curl</span> -X POST https://opesbooks.cm/api/v1/integration/invoices \
...
<!-- Endpoints -->
<div class="mb-8 bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden">
