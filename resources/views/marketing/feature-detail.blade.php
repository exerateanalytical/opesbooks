...
<section class="max-w-5xl mx-auto px-5 pb-10">
    <div class="glass rounded-2xl p-8" style="background:linear-gradient(135deg,{{ $c['glow'] }},rgba(37,51,71,0.5))">
...
<section class="max-w-5xl mx-auto px-5 pb-20">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <a href="{{ route('m.feature', $r['slug']) }}" class="glass rounded-xl p-4 hover:bg-slate-700 transition text-center group">
            <div class="w-8 h-8 rounded-lg flex items-center justify-center mx-auto mb-2" style="background:rgba(28,42,58,0.6);border:1px solid #253347">
...
<section class="max-w-4xl mx-auto px-5 pb-20 text-center">
    <div class="glass rounded-3xl p-10" style="background:linear-gradient(145deg,rgba(245,158,11,0.08),rgba(37,51,71,0.5))">
