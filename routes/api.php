...
Route::prefix('v1')->name('v1.')->group(function () {
    ...
    Route::middleware(['auth:sanctum', \App\Http\Middleware\RequireActiveSubscription::class, \App\Http\Middleware\EnforceReadOnlyRole::class])
        ...
        Route::prefix('auth')->name('auth.')->group(function () {
            ...
            Route::put('notifications', [AuthController::class, 'updateNotificationPrefs'])->name('notifications.prefs');
        ...
        Route::prefix('companies/{company}')->middleware(\App\Http\Middleware\EnsureCompanyAccess::class)->name('companies.')->group(function () {
            ...
            Route::middleware(\App\Http\Middleware\RequireRole::class . ':OWNER,ACCOUNTANT')
                ...
                // Dashboard aggregates (trend, recent, aging, cash)
                Route::get('dashboard/summary', [\App\Http\Controllers\Api\V1\DashboardController::class, 'summary'])->name('dashboard.summary');
