...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth', 'superadmin', 'audit'])->group(function () {
        ...
        Route::get('/companies/{company}/data',          [\App\Http\Controllers\Admin\AdminDashboardController::class, 'companyData'])->name('company.data');
        Route::post('/companies/{id}/restore',           [\App\Http\Controllers\Admin\AdminDashboardController::class, 'restoreCompany'])->name('company.restore');
        ...
        Route::post('/administrators/{user}/reinstate', [\App\Http\Controllers\Admin\PlatformAdminController::class, 'reinstate'])->name('administrators.reinstate');
